...
**How to apply:** Run `xcodegen generate` and the provided build script on macOS or a macOS CI runner, then configure the `group.app.tilawa` App Group for signed widget builds.